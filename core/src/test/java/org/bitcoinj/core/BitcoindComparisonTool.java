...
/**
 * A tool for comparing the blocks which are accepted/rejected by dashd/xebecj
 * It is designed to run as a testnet-in-a-box network between a single dashd node and xebecj
...
public class BitcoindComparisonTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("USAGE: xebecjBlockStoreLocation runExpensiveTests(1/0) [port=18444]");
